...
namespace ServiceRest_20190140004_FadhilahRizkySetiawan
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=FADHILAHRIZ;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa; Password=12345 ");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=FADHILAHRIZ;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa; Password=12345 ");
